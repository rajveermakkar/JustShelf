      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg">JustShelf</h3>
            <p className="text-gray-600 text-sm">
              Discover a world of stories, ideas, and knowledge. Our curated collection brings
              the best books to your doorstep.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>123 Book Lane, Reading, RG1 2JA</li>
              <li>+1 (234) 567-8901</li>
              <li>hello@justshelf.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-12 pt-8">
          <div className="text-center text-gray-600 text-sm">
            <p>© {new Date().getFullYear()} JustShelf. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
